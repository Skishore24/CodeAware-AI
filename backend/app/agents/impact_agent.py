    ...
    def run(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not repository_path:
            ...
            if not repository_name:
                ...
                return {
                    "success": False,
                    "agent": self.name,
                    "error": ("repository_name or " "repository_path is required."),
                }

            from app.config.paths import CLONED_REPOSITORIES_DIR

            repository_path = CLONED_REPOSITORIES_DIR / repository_name
        ...
        if not repository_path.exists():
            ...
            return {
                "success": False,
                "agent": self.name,
                "error": (f"Repository does not exist: " f"{repository_path}"),
            }
        ...
        try:
            ...
            graph_service = GraphService(repository_path)

            result = graph_service.get_impact(symbol)
